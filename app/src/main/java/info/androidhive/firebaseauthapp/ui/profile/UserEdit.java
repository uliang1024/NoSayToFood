...
public class UserEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_years.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(UserEdit.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(tv_gender.getText().toString().equals("")){
                    Toast.makeText(UserEdit.this, "請輸入「性別」", Toast.LENGTH_LONG).show();
                }else if(tv_age.getText().toString().equals("")){
                    Toast.makeText(UserEdit.this, "請輸入「年齡」", Toast.LENGTH_LONG).show();
                }else if(tv_height.getText().toString().equals("")){
                    Toast.makeText(UserEdit.this, "請輸入「身高」", Toast.LENGTH_LONG).show();
                }else if(tv_width.getText().toString().equals("")){
                    Toast.makeText(UserEdit.this, "請輸入「體重」", Toast.LENGTH_LONG).show();
                }else if(tv_waistline.getText().toString().equals("")){
                    Toast.makeText(UserEdit.this, "請輸入「腰圍」", Toast.LENGTH_LONG).show();
                }else if(tv_exercise.getText().toString().equals("")){
                    Toast.makeText(UserEdit.this, "請輸入「每日活動量」", Toast.LENGTH_LONG).show();
                }else {
    ...
    public  void AddData() {
        ...
        if(updateData2){
            Toast.makeText(UserEdit.this,"Data updated",Toast.LENGTH_LONG).show();

        }
        else {
            Toast.makeText(UserEdit.this, "Data not updated", Toast.LENGTH_LONG).show();
        }
    ...
    public void height(View view) {
        LayoutInflater inflater = LayoutInflater.from(UserEdit.this);
    ...
    private void initNumberPicker3() {
        ...
        bt_go.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(UserEdit.this, PersonalProfile.class));
                finish();
            }
        });
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) { // 攔截返回鍵
            ...
            GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                    ...
                    .requestEmail()
                    .build();
            GoogleSignIn.getClient(UserEdit.this, gso).signOut().addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull Task<Void> task) {
                    Toast.makeText(UserEdit.this, "尚未登入", Toast.LENGTH_LONG).show();
                    Intent accountIntent = new Intent(UserEdit.this, PersonalProfile.class);
