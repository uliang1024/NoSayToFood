...
public class Fruit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView.setAdapter(new Fruit.MyExpandableListView());
    ...
    public void what(final View v ,final int groupPosition, final int childPosition) {
        final LayoutInflater inflater = LayoutInflater.from(Fruit.this);
        final View view = inflater.inflate(R.layout.show_food, null);
        new AlertDialog.Builder(Fruit.this)
