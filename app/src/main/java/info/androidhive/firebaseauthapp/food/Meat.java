...
public class Meat extends AppCompatActivity {
    ...
    private String[] Name = {"魚","肉","豆","蛋"};
    private String[] Content = {"", "", "", ""};
    //注意，字符数组不要写成{{"A1,A2,A3,A4"}, {"B1,B2,B3,B4，B5"}, {"C1,C2,C3,C4"}}
    private String[][] childs = {{"蛤蠣1個(5.5)", "蝦仁1隻(5.5)", "魚肉1(5.5)","虱目魚1兩(75)"},
            {"火腿1片(55)", "雞胸肉1兩(55)", "雞腿1隻(165)","肉鬆2湯匙(75)","牛腩1兩(120)","牛腱1兩(55)"},
            {"豆干3片(75)"},
            {"雞蛋1個(75)"}};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView.setAdapter(new Meat.MyExpandableListView());
    ...
    public void what(final View v ,final int groupPosition, final int childPosition) {
        final LayoutInflater inflater = LayoutInflater.from(Meat.this);
