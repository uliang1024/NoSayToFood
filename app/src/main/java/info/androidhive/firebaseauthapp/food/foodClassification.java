...
public class foodClassification extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_milk = findViewById(R.id.bt_milk);
        Button bt_fruit = findViewById(R.id.bt_fruit);
        Button bt_vegetables = findViewById(R.id.bt_vegetables);
        Button bt_meet = findViewById(R.id.bt_meet);
        Button bt_grain = findViewById(R.id.bt_grain);
        Button bt_oil = findViewById(R.id.bt_oil);

        button = findViewById(R.id.button);

        Button bt_recommend = findViewById(R.id.bt_recommend);
        bt_what = findViewById(R.id.bt_what);

        bt_recommend.setOnClickListener(v -> new AlertDialog.Builder(foodClassification.this)
                .setTitle("六大類飲食建議份數")
                ...
                .setNeutralButton("問題?", (dialog, which) -> startActivity(new Intent(foodClassification.this,ScreenSlidePagerActivity.class)))

                .show());
        bt_what.setOnClickListener(v -> startActivity(new Intent(foodClassification.this,ScreenSlidePagerActivity.class)));

        bt_oil.setOnClickListener(v -> {
        ...
        bt_vegetables.setOnClickListener(v -> {
            LayoutInflater inflater = LayoutInflater.from(foodClassification.this);
            final View view = inflater.inflate(R.layout.show_yourkg, null);
            new AlertDialog.Builder(foodClassification.this)
                    .setTitle("蔬菜類吃多少(份)?")
    ...
    private final Runnable updateTimer = new Runnable() {
        public void run() {
            ...
            SimpleAdapter simpleAdapter = new SimpleAdapter(foodClassification.this,
