...
public class Vegetables extends AppCompatActivity {
    ...
    private String[] Name = {"蔬菜類"};
    private String[] Content = {"每份 100 公克(可食部分)含蛋白質 1 公克，醣類 5 公克，熱量 25 大卡"};
    //注意，字符数组不要写成{{"A1,A2,A3,A4"}, {"B1,B2,B3,B4，B5"}, {"C1,C2,C3,C4"}}
    private String[][] childs = {{"芹菜100g(25)","青椒100g(25)","苦瓜100g(25)","冬瓜100g(25)","大白菜100g(25)","木耳100g(25)","萵苣100g(25)","絲瓜100g(25)","大頭菜100g(25)"}};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView.setAdapter(new Vegetables.MyExpandableListView());
    ...
    public void what(final View v ,final int groupPosition, final int childPosition) {
        final LayoutInflater inflater = LayoutInflater.from(Vegetables.this);
        final View view = inflater.inflate(R.layout.show_food, null);
        new AlertDialog.Builder(Vegetables.this)
